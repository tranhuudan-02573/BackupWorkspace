...
//	JLabel label;
	...
	public About() {
//		label = new JLabel("ấdsad");
//		label.setIcon(new ImageIcon(new ImageIcon("./btTuLuyen/MyPaint/author.png").getImage().getScaledInstance(50, 50,
//				DO_NOTHING_ON_CLOSE)));
		setTitle("About");
		...
		contentPane = new JPanel() {
			protected void paintComponent(Graphics g) {
				...
				g.drawImage(new ImageIcon(new ImageIcon("./src/pain/author.png").getImage()
