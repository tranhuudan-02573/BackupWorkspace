...
public class TextSamplerDemo extends JFrame implements ActionListener {
	...
	public TextSamplerDemo() {
		...
		JTextArea textArea = new JTextArea("This is an editable JTextArea "
				+ "that has been initialized with the setText method. " + "A text area is a \"plain\" text component, "
		...
		areaScrollPane.setBorder(BorderFactory
				.createCompoundBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Plain Text"),
	...
	private JEditorPane createEditorPane() {
		...
		String s = null;
		try {
			s = "file:" + System.getProperty("user.dir") + System.getProperty("file.separator")
