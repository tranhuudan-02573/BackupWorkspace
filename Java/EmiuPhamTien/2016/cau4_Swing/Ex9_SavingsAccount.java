...
import cau3_OOP.SavingAccount;

public class Ex9_SavingsAccount extends JFrame implements ActionListener {
	...
	public Ex9_SavingsAccount() {
		...
		jta.setBorder(BorderFactory.createTitledBorder("Saving Account Infomation"));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == jbtAdd) {
			try {
				...
				SavingAccount account = new SavingAccount(name, id, ir, cb);
	...
	public String toString() {
		...
		for (SavingAccount savingAccount : accounts) {
			sb.append(savingAccount.toString() + "\n");
		}
		return sb.toString();
	}
}
